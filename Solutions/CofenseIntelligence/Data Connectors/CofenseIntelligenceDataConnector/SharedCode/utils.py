...
class Utils:
    ...
    def validate_params(self):
        ...
        required_params = {
            ...
            "AzureClientSecret": "" if consts.AZURE_CLIENT_SECRET is None or consts.AZURE_CLIENT_SECRET == "" else self.f.encrypt(consts.AZURE_CLIENT_SECRET),
            ...
            "Cofense_password": "" if consts.COFENSE_PASSWORD is None or consts.COFENSE_PASSWORD == "" else self.f.encrypt(consts.COFENSE_PASSWORD),
